    ...
    def _get_node_features(self, agent):
        ...
        for entity in self.entities:
            ...
            if entity.type == 'agent':
                # Get the goal locations from the other agent
                ...
                if entity.type == 'goal':
                    ...
                    elif entity.collected:
                        entity_features.append(2)
                elif entity.type == 'obstacle':
                    entity_features.append(3)
                else:
                    raise ValueError(f"Unknown entity type: {entity.type}")

            features.append(entity_features)
        
        # [[[rel_pos, rel_goal_pos1, ..., entity_type], [rel_pos, rel_goal_pos2, ...], ...], ...]
